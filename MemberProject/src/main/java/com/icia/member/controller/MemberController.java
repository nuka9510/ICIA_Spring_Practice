...
public class MemberController {
	...
	private @ResponseBody String idDuplicate(@ModelAttribute MemberDTO dto) {
		return service.idDuplicate(dto);
	}
	
	@RequestMapping(value = "/memberInfoAjax", method = RequestMethod.POST)
	private @ResponseBody MemberDTO memberInfoAjax(@ModelAttribute MemberDTO dto) {
		return service.memberInfo(dto);
	}
}
